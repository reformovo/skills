...
| Skill | Description |
|-------|-------------|
| [kubernetes-best-practices](skills/kubernetes-best-practices) | Kubernetes best practices: workload manifests, security contexts, RBAC, NetworkPolicies, configuration, storage, autoscaling, reliability, Helm/GitOps, and troubleshooting |
...
| [rust-best-practices](skills/rust-best-practices) | Apollo Rust Best Practices distilled for agents: ownership, borrowing, errors, linting, tests, documentation, dispatch, type-state, pointers, and performance measurement | [apollographql/rust-best-practices](https://github.com/apollographql/rust-best-practices) |
