...
For skills that are hand-written with specific preferences, experience, tastes and best practices.
...
metadata:
  author: reformovo
  version: "2026.1.1"
  source: Generated from {source-url}, scripts located at https://github.com/reformovo/skills
---
...
7. **No emojis** - Avoid emojis in skill content; use text labels (e.g., `Good:`/`Bad:`, `(highest leverage)`) instead
